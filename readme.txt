...
Plot your address on a Google Map, with easy to use interface and simple short code.

== Description ==

WPME Google Maps adds basic Google Maps feature to your website. The simple yet intuitive interface allows to insert a map anywhere on your post or page, in less than a minute.

The powerful short code offers several attributes to place a map directly.

This is as simple as:

[wpme-gmap address="123 ABC Building, Street 99, Sydney - 12345, Australia"]

WPME Google Maps offers following features:
